...
lv_obj_t *ui_settingsComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text(cui_settingsBackLightPanelLabel, "返回 " LV_SYMBOL_CHARGE);
    ...
    lv_label_set_text(cui_screenInvertLabel, LV_SYMBOL_IMAGE " 色彩反转");
    ...
    lv_label_set_text(cui_settingsTFTFlipLabel, LV_SYMBOL_SHUFFLE " 屏幕翻转");
    ...
    lv_label_set_text(cui_pairingTitle, LV_SYMBOL_LIST " 已连接打印机");
    ...
    lv_label_set_text(cui_clearAccesCodeCacheButton, LV_SYMBOL_TRASH " 清除连接认证码");
    ...
    lv_label_set_text(cui_settings_auxFanLabel, "辅助冷却风扇");
    ...
    lv_label_set_text(cui_settings_chamberFanLabel, "机箱调节风扇");
    ...
    lv_label_set_text(cui_settings_chamberSensorLabel, "机箱温度传感器");
    ...
    lv_label_set_text(cui_settings_otaLabel, "在线升级");
    ...
    lv_label_set_text(cui_reseDeviceButton, LV_SYMBOL_POWER " 重启设备");
